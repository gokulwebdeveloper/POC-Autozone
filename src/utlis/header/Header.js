  ...
  return (
        ...
        <div className="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
          ...
          <div className="header-meta d-flex clearfix justify-content-end">
            ...
            <div className="cart-area" onClick={openNav}>
              <a id="essenceCartBtn">
                <img src="img/core-img/bag.svg" alt="" /> <span>{props.cartData.length}</span>
              </a>
            </div>
          </div>
        </div>
    ...
    <div id="cartOverlayContent" className="right-side-cart-area" >
        ...
        <div className="cart-button" onClick={closeNav}>
            <a className="autozone-bag-icon"><img src="img/core-img/bag.svg" alt=""/> <span>{props.cartData.length}</span></a>
        </div>
