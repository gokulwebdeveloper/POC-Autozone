...
const Navigation = () => {
   useEffect(() => {
      $(".classynav ul").find("li a").each(function () {
        $(this).next().length > 0 && ($(this).parent("li").addClass("has-down").append('<span class="dd-trigger"></span>'),
         $(this).parent("li").addClass("has-down").append('<span class="dd-arrow"></span>'))
      });

        $(".classynav ul").find("li .dd-trigger").on("click", function (n) {
          n.preventDefault(), $(this).parent("li").children("ul").stop(!0, !0).slideToggle(300), 
          $(this).parent("li").toggleClass("active")
        });

      $(".classycloseIcon").on("click", function () {
        $(".classy-menu").removeClass("menu-on"), t.removeClass("active")
      });
